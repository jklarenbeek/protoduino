...
static ptstate_t protothread3(struct pt * self)
{
  ...
  {
    print_error_P(PSTR("PT_CATCH(PT_ERROR + 2) AND THROW protothread3"), PT_ERROR_STATE);
    PT_THROW(self, PT_ERROR + 2);
  }
  PT_CATCH(self, PT_ERROR + 3)
  {
    print_error_P(PSTR("PT_CATCH(PT_ERROR + 3) AND THROW protothread3"), PT_ERROR_STATE);
    PT_THROW(self, PT_ERROR_STATE);
  }
  PT_CATCHANY(self)
  {
    print_error_P(PSTR("PT_CATCHANY() AND RETHROW protothread3"), PT_ERROR_STATE);
    PT_RETHROW(self);
  }
