...
static volatile uart_on_rx_complete_fn _uart0_on_rx_complete = 0;
static volatile uart_on_rx_error_fn _uart0_on_rx_error = 0;
static volatile uart_on_tx_complete_fn _uart0_on_tx_complete = 0;

static uint32_t _uart0_baudrate = 0;

void uart0_on_rx_complete(uart_on_rx_complete_fn callback)
{
  _uart0_on_rx_complete = callback;
}

void uart0_on_rx_error(uart_on_rx_error_fn callback)
{
  _uart0_on_rx_error = callback;
}

void uart0_on_tx_complete(uart_on_tx_complete_fn callback)
{
...
void uart0_open(uint32_t baud)
{
  ...
  uart0_openex(baud, (__UCSZ1__ | __UCSZ2__));
}

void uart0_openex(uint32_t baud, uint8_t options)
{
...
uint_fast8_t uart0_rx_error(void)
{
...
uint_fast8_t uart0_rx_read8(void)
{
